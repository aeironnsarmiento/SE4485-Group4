...
script_dir = os.path.dirname(os.path.abspath(__file__))  # Directory of the gui.py script
package_script_path = os.path.join(script_dir, 'package.py')  # Path to package.py
